...
import com.dushuge.controller.net.OkHttp3;
import com.dushuge.controller.net.ReaderParams;
import com.dushuge.controller.net.ResultCallback;
import com.dushuge.controller.ui.bwad.TTAdManagerHolder;
import com.dushuge.controller.ui.utils.Cockroach;
...
public class BWNApplication extends Application {
    ...
    public void onCreate() {
        ...
        //数据库
        if (!ShareUitls.getBoolean(this, "BW2" + BuildConfig.VERSION_CODE, false)) {
            ClearCacheManager.clearObjectBoxAllCache(applicationContext);
            ShareUitls.putBoolean(this, "BW2" + BuildConfig.VERSION_CODE, true);
        }
    ...
    private void initStarrySky() {
        StarrySky.init(applicationContext, new StarrySkyConfig() {
            ...
            public void applyOptions(@NonNull Context context, @NonNull StarrySkyBuilder builder) {
                ...
                String destFileDir = Environment.getExternalStorageDirectory().getAbsolutePath() + "/dushuge/cache/";
