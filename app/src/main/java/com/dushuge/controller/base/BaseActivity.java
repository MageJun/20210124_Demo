package com.dushuge.controller.base;
...
import com.dushuge.controller.eventbus.DownOver;
import com.dushuge.controller.eventbus.FinaShActivity;
...
import com.dushuge.controller.ui.activity.SettingActivity;
...
import com.dushuge.controller.ui.view.screcyclerview.MyContentLinearLayoutManager;
...
import static com.dushuge.controller.ui.utils.StatusBarUtil.setFullScreen;
...
public abstract class BaseActivity extends FragmentActivity implements BaseInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TOP_HEIGTH = ImmersionBar.getStatusBarHeight(activity) + ImageUtil.dp2px(activity, 10);
        // 初始化View注入
        initBaseView();
        if (!isImmersionbar) {
            // 状态栏设置
    ...
    public void onEndRecommend(BookEndRecommendRefresh recommendRefresh) {
        if (recommendRefresh.isFinish && recommendRefresh.isFinishAll && !(activity instanceof MainActivity)) {
            finish();
        }
    }
