...
import static com.dushuge.controller.utils.RegularUtlis.isNumber;
...
public class PublicIntent {
    ...
    public static Intent intentTo(Context activity, int skip_type, String content, String title) {
