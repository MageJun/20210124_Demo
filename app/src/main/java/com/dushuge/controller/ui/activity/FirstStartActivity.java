...
import com.dushuge.controller.model.FirstNovelRecommend;
import com.dushuge.controller.model.Recommend;
import com.dushuge.controller.net.HttpUtils;
import com.dushuge.controller.net.ReaderParams;
import com.dushuge.controller.ui.adapter.FirstChooseBookAdapter;
...
import static com.dushuge.controller.constant.Constant.PUTNotchHeightE;
                    ...
                    if (addrecommendProducs.isEmpty()) {
                        ...
                        for (Recommend.RecommendProduc addrecommendProducs : addrecommendProducs) {
                            if (addrecommendProducs.book_id != 0) {
                                ...
                                mBook.setAuthor_name(addrecommendProducs.author);
                                ...
                                baseComic.setAuthor(addrecommendProducs.author);
                                ...
                                baseAudio.setAuthor(addrecommendProducs.author);
