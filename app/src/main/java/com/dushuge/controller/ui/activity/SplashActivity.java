...
import com.dushuge.controller.base.BaseInterface;
...
import com.dushuge.controller.ui.dialog.GetDialog;
...
public class SplashActivity extends FragmentActivity implements BaseInterface {
        ...
        switch (v.getId()) {
            ...
            case R.id.activity_splash_im:
                if (activity != null && !activity.isFinishing() && startpage != null &&
                    ...
                    startActivity(PublicIntent.intentTo(activity, startpage.skip_type, startpage.content, startpage.title));
                    isJump = true;
                    if (!HOME_AD) {
    ...
    public void initView() {
        ...
        params.topMargin = ImmersionBar.getStatusBarHeight(activity) + ImageUtil.dp2px(activity, 10);
        ...
        if (!HOME_AD) {
            ...
            if (!TextUtils.isEmpty(response)) {
                AppUpdate dataBean = HttpUtils.getGson().fromJson(response, AppUpdate.class);
