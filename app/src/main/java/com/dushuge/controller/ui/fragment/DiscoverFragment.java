...
import com.dushuge.controller.eventbus.DiscoverExpierTimeEnd;
...
import com.dushuge.controller.model.DiscoverComicData;
...
import com.dushuge.controller.ui.adapter.DiscoverComicAdapter;
        ...
        if (productType == BOOK_CONSTANT || productType == AUDIO_CONSTANT) {
            ...
            if (comicStoare.item_list != null) {
                if (current_page <= comicStoare.item_list.total_count && !comicStoare.item_list.list.isEmpty()) {
                    ...
                    if (comicStoare.item_list.current_page >= comicStoare.item_list.total_page) {
                        mPublicRecycleview.setLoadingMoreEnabled(false);
                    }
                }
