...
import com.dushuge.controller.model.UserInfoItem;
...
import com.dushuge.controller.ui.activity.UserInfoActivity;
import com.dushuge.controller.ui.adapter.MineListAdapter;
    ...
    public void initInfo(String json) {
        ...
        if (!TextUtils.isEmpty(json)) {
            ...
            if (!UserUtils.isLogin(activity)) {
                ...
                viewHolder.mine_login.setVisibility(View.VISIBLE);
                if (USE_PAY) {
                    viewHolder.mine_vip_icon.setVisibility(View.VISIBLE);
                    viewHolder.mine_vip_icon.setImageResource(
                            userInfoItem.getIs_vip() == 1 ? R.mipmap.icon_isvip : R.mipmap.icon_novip);
                } else {
                    viewHolder.mine_vip_icon.setVisibility(View.GONE);
                }
