...
import com.dushuge.controller.eventbus.RefreshComicShelf;
...
import com.dushuge.controller.model.Announce;
import com.dushuge.controller.model.Audio;
import com.dushuge.controller.model.AudioChapter;
...
import com.dushuge.controller.model.ShelfAudioBeen;
import com.dushuge.controller.model.ShelfBookBeen;
import com.dushuge.controller.model.ShelfComicBeen;
...
import com.dushuge.controller.ui.activity.AnnounceActivity;
import com.dushuge.controller.ui.activity.AudioInfoActivity;
import com.dushuge.controller.ui.activity.BookInfoActivity;
import com.dushuge.controller.ui.activity.ComicInfoActivity;
import com.dushuge.controller.ui.activity.ComicLookActivity;
import com.dushuge.controller.ui.activity.LoginActivity;
import com.dushuge.controller.ui.activity.TaskCenterActivity;
import com.dushuge.controller.ui.adapter.ShelfAdapter;
import com.dushuge.controller.ui.adapter.ShelfBannerHolderView;
import com.dushuge.controller.ui.audio.fragment.AudioInfoCatalogFragment;
...
import com.dushuge.controller.ui.dialog.WaitDialog;
import com.dushuge.controller.ui.audio.AudioSoundActivity;
...
import com.dushuge.controller.ui.view.MarqueeTextView;
import com.dushuge.controller.ui.view.MarqueeTextViewClickListener;
import com.dushuge.controller.ui.view.banner.ConvenientBanner;
import com.dushuge.controller.ui.view.banner.holder.CBViewHolderCreator;
import com.dushuge.controller.ui.view.banner.listener.OnItemClickListener;
...
public class ShelfFragment extends BaseFragment {
    ...
    private void updateData(String result) {
        if (productType == BOOK_CONSTANT) {
            ...
            if (shelfComicBeen.list != null && !shelfComicBeen.list.isEmpty()) {
                for (Comic Book : shelfComicBeen.list) {
                    Book.is_collect = 1;
                    int position = comicList.indexOf(Book);
                    if (position != -1) {
                        Comic LocalBook = comicList.get(position);
                        LocalBook.new_chapter = Book.total_chapters - LocalBook.total_chapters;
                        LocalBook.total_chapters = Book.total_chapters;
                        LocalBook.vertical_cover = Book.vertical_cover;
                        LocalBook.author = Book.author;
                        ObjectBoxUtils.addData(LocalBook, Comic.class);
                    } else {
                        objectList.add(Book);
                        comicList.add(Book);
                        ObjectBoxUtils.addData(Book, Comic.class);
                    }
                }
                shelfAdapter.notifyDataSetChanged();
            }
            ...
            if (shelfComicBeen.list != null && !shelfComicBeen.list.isEmpty()) {
                for (Audio Book : shelfComicBeen.list) {
                    Book.is_collect = 1;
                    int position = audioList.indexOf(Book);
                    if (position != -1) {
                        ...
                        objectList.add(Book);
                        audioList.add(Book);
                        ObjectBoxUtils.addData(Book, Audio.class);
                    }
                }
                shelfAdapter.notifyDataSetChanged();
            }
    ...
    private void initBannerAnnounce(List<Announce> announce, List<BaseBookComic> recommend_list) {
        ...
        if (announce != null && !announce.isEmpty()) {
            ...
            viewHolder.fragmentBookshelfMarqueeLayout.setVisibility(View.GONE);
        }
    }
