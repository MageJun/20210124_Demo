package com.dushuge.controller.ui.localshell.calendar;
...
public class CustomWeekView extends WeekView {
    ...
    public CustomWeekView(Context context) {
        super(context);
        mTextPaint.setTextSize(ImageUtil.dp2px(context, 8));
        ...
        mCircleRadius = ImageUtil.dp2px(getContext(), 7);
        mPadding = ImageUtil.dp2px(getContext(), 3);
        mPointRadius = ImageUtil.dp2px(context, 2);

        Paint.FontMetrics metrics = mSchemeBasicPaint.getFontMetrics();
        mSchemeBaseLine = mCircleRadius - metrics.descent + (metrics.bottom - metrics.top) / 2 + ImageUtil.dp2px(getContext(), 1);
    }
