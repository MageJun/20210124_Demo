package com.dushuge.controller.ui.localshell.localapp.view;
...
public class LineBreakLayout extends ViewGroup {
    ...
    public LineBreakLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        FIRST_LEFT_RIGHT_SPACE = ta.getDimensionPixelSize(R.styleable.LineBreakLayout_firstleftAndRightSpace, 0);
