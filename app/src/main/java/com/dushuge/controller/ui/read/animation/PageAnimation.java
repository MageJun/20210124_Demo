...
public abstract class PageAnimation {
    ...
    protected int durationTime = 400;
    //正在使用的View
    ...
    public boolean isRunning = false,autoPageIsRunning;
    ...
    public void onTouchEvent(MotionEvent event, OnAnimationStopped onAnimationStopped) {
    ...
    public interface OnPageChangeListener {
        ...
        boolean hasPrev(boolean isJudgeHasPre);

        boolean hasNext(boolean isAuto);
    ...
    public interface OnAnimationStopped {
        ...
        void Stop(boolean Direction, boolean isCancel);
    }
