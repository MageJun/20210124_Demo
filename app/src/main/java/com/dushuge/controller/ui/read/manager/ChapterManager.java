package com.dushuge.controller.ui.read.manager;
...
import com.dushuge.controller.eventbus.BookCatalogMarkRefresh;
...
import com.dushuge.controller.model.BookChapterCatalog;
...
import com.dushuge.controller.ui.dialog.WaitDialogUtils;
import com.dushuge.controller.ui.read.ReadActivity;
import com.dushuge.controller.model.BookMarkBean;
import com.dushuge.controller.ui.read.page.TxtPage;
                ...
                if (!bookChapters.isEmpty()) {
                    for (BookChapter chapterItem : bookChapters) {
                        ...
                        if (position != -1) {
                            ...
                            chapterItem.chapter_text = bookChapterLocal.chapter_text;
