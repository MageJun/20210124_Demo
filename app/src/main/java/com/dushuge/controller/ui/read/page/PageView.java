...
import com.dushuge.controller.ui.read.animation.CoverPageAnim;
import com.dushuge.controller.ui.read.animation.HorizonPageAnim;
import com.dushuge.controller.ui.read.animation.NonePageAnim;
import com.dushuge.controller.ui.read.animation.PageAnimation;
import com.dushuge.controller.ui.read.animation.ScrollPageAnim;
import com.dushuge.controller.ui.read.animation.SimulationPageAnim;
import com.dushuge.controller.ui.read.animation.SlidePageAnim;
...
import static com.dushuge.controller.constant.Constant.getIsReadBottomAd;
import static com.dushuge.controller.constant.Constant.getIsReadCenterAd;
import static com.dushuge.controller.ui.bwad.WebAdshow.ClickWebAd;
import static com.dushuge.controller.ui.read.page.PageLoader.STATUS_EMPTY;
                ...
                if (isCancel) {
                    if (mPageLoader != null && mPageLoader.mCurPage != null && mPageLoader.mCurPage.pageStyle == 3) {
                        if (ADview.getChildCount() == 0) {
                            ...
                            ADview.setVisibility(VISIBLE);
                            if (mPageLoader.mCurPage.drawAdOver = false) {
                                Bitmap bitmapAD = bitmapCache.getBitmapFromCache("baseAdCenter");
                                if (bitmapAD == null) {
                                    bitmapAD = ViewToBitmapUtil.convertViewToBitmap(ADview);
                                    bitmapCache.addBitmapToCache("baseAdCenter", bitmapAD);
                                }
                                if (mPageLoader.canvas != null && mPageLoader.mCurPage.pageStyle == 3) {
