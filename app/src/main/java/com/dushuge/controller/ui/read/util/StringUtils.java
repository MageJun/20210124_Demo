package com.dushuge.controller.ui.read.util;
...
public class StringUtils {
    ...
    public static String getString(@StringRes int id) {
        return BWNApplication.applicationContext.getResources().getString(id);
    }

    public static String getString(@StringRes int id, Object... formatArgs) {
        return BWNApplication.applicationContext.getResources().getString(id, formatArgs);
    }
