...
public class StatusBarUtil {
    ...
    /**
     * @param activity 不透明状态栏
     */
    public static void setStatusTextColor(Activity activity,boolean useDart) {
        if (activity != null) {
            ImmersionBar.with(activity).transparentStatusBar().statusBarDarkFont(useDart).statusBarColor(R.color.white) .init();
        }
    }
     ...
     * @param useDart
     */
    public static void setStatusStoreColor(Activity activity,boolean useDart){
        ImmersionBar.with(activity)
                .transparentStatusBar()
                .statusBarDarkFont(useDart)
