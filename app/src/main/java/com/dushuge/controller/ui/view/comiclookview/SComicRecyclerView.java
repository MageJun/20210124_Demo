package com.dushuge.controller.ui.view.comiclookview;
...
public class SComicRecyclerView extends RecyclerView {
    ...
    public float start_scory_y, end_scory_y;
    public boolean SlidingDirection;//滑动方向 默认上
    ...
    private Boolean setTouch(@NonNull MotionEvent ev) {
        ...
        switch (ev.getActionMasked()) {
            ...
            case ACTION_MOVE: {
                end_scory_y = ev.getY();
                if (end_scory_y - start_scory_y > 0) {
                    SlidingDirection = true;
                } else {
