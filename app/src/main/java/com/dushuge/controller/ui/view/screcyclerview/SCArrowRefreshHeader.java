...
public class SCArrowRefreshHeader extends LinearLayout implements aseRefreshHeader {
    ...
    private SCSimpleViewSwitcher mProgressBar;
    ...
    public SCArrowRefreshHeader(Context context) {
        super(context);
        initView();
    }
     ...
     * @param attrs
     */
    public SCArrowRefreshHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(
                R.layout.sc_listview_header, null);
    ...
    public void setState(int state) {
        ...
        switch(state){
            case STATE_NORMAL:
                ...
                mStatusTextView.setText(R.string.app_pull_to_refresh);
                break;
            case STATE_RELEASE_TO_REFRESH:
                if (mState != STATE_RELEASE_TO_REFRESH) {
                    mArrowImageView.clearAnimation();
                    mArrowImageView.startAnimation(mRotateUpAnim);
                    mStatusTextView.setText(R.string.app_freed_to_refresh);
                }
                break;
            case STATE_REFRESHING:
                mStatusTextView.setText(R.string.app_refreshing);
                break;
            case STATE_DONE:
                mStatusTextView.setText(R.string.app_refresh_done);
                break;
            default:
        }
