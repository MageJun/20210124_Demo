...
public class SCLoadingMoreFooter  extends LinearLayout {
    ...
    public SCLoadingMoreFooter(Context context) {
        super(context);
        initView();
    }
     ...
     * @param attrs
     */
    public SCLoadingMoreFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
